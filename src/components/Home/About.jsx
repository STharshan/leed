...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "I’ve been using Leeds Motorcycle MOT Centre for years for all my bikes, and they’ve consistently provided reliable and helpful service. Booking is straightforward, and they even offer a convenient collection and delivery option. The team is always friendly and professional. They can get quite busy, but that just shows how trusted they are. I highly recommend them.",
    name: "Tomasz Malka",
  },
